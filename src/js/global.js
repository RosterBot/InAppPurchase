...
function purchaseProduct(productIdentifier, quantity, username) {
    return new Promise(function (resolve, reject) {
        if (typeof productIdentifier === 'string' || productIdentifier instanceof String) {
            exec(resolve, reject, "InAppPurchase", "purchaseProduct", [productIdentifier, quantity, username]);
        }
        else {
...
function finishTransaction(transactionId, successCallback, failCallback) {
    return new Promise(function (resolve, reject) {
